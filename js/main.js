...
function initMap() {
  ...
  // Create an array of markers with the locations array
  ...
  // Populate the infowindow when a marker is clicked
  function populateInfoWindow(marker, infowindow) {
    // Check if the infowindow is already open on this marker
